...
{
    [Key]
    public int? RequestNumber { get; set; } // Artık nullable

    // FormData ile gelen tüm bilgileri ekleyebilirsiniz
    ...
    public string? LandAda { get; set; }
    public string? LandParsel { get; set; }
    ...
    public DateTime? CreatedDate { get; set; } // Artık nullable
    public string? InterestedPerson { get; set; }  // Yeni alan
}
