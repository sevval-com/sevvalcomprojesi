...
,
    ...
    public async Task<IActionResult> HizliAra(string anahtarKelime, DetayliAramaRequestDTO detayliAramaRequestDTO)
    {
        ...
        var query = _context.IlanBilgileri.AsNoTracking().Where(x =>
            ...
            (
                string.IsNullOrEmpty(detayliAramaRequestDTO.Il) ||
                (x.sehir ?? "").ToUpper() == (detayliAramaRequestDTO.Il ?? "").ToUpper()
            ) &&
            (
                string.IsNullOrEmpty(detayliAramaRequestDTO.Ilce) ||
                (x.semt ?? "") == detayliAramaRequestDTO.Ilce
        ...
        ViewBag.EnDusukFiyat = detayliAramaRequestDTO.EnDusukFiyat;
        ViewBag.EnYuksekFiyat = detayliAramaRequestDTO.EnYuksekFiyat;
        ViewBag.EnAzMetrekare = detayliAramaRequestDTO.EnAzMetrekare;
        ViewBag.EnCokMetrekare = detayliAramaRequestDTO.EnCokMetrekare;
        ViewBag.Il = detayliAramaRequestDTO.Il;
